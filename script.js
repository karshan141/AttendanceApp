...
function showSection(sectionId) {
  const sections = ["attendanceSection", "reportSection", "pendingOffSection", "matrixSection"];
  const tabs = ["attendanceTab", "reportTab", "pendingOffTab", "matrixTab"];
  sections.forEach(id => document.getElementById(id).style.display = "none");
  tabs.forEach(id => document.getElementById(id).classList.remove("active-tab"));

  document.getElementById(sectionId).style.display = "block";
  if (sectionId === "reportSection") showReport();
  if (sectionId === "pendingOffSection") showPendingOffs();
  if (sectionId === "matrixSection") document.getElementById("matrixReport").innerHTML = "";
